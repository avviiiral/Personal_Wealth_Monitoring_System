...
- Total-return identifier: `BSE500` (BSE methodology's Bloomberg/Reuters TRI code).
...
- BSE 500 is fetched automatically in bounded annual windows and cached locally as `backend/watchlist/data/bse500_tri.csv`.
...
- Do not substitute BSE 500 PRI. The loader rejects a BSE response whose returned index identity is not BSE500 / BSE 500.
