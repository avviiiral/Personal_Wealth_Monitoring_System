...
export interface HoldingMatrixResponse { success: boolean; count: number; underlyings: string[]; underlying_details?: HoldingMatrixUnderlyingDetail[]; results: Array<Record<string, number | string> & { asset_name: string }>; }
